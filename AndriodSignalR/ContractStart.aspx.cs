...
{
    public partial class ContractStart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Common.AddPageConnection(desktopdeviceId, androidevice, "1");

            btnNext.NavigateUrl="http://websignalr.kindlebit.com/ContractStep1.aspx?deskdevice=" + query;
        }
    }
}